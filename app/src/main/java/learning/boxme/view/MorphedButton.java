 ...
 */
    ...
    public class MorphedButton extends Button {
        ...
        public MorphedButton(Context context) {
            super(context);
            initView();
        }

        public MorphedButton(Context context, AttributeSet attrs) {
            super(context, attrs);
            initView();
        }

        public MorphedButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        private void initView() {
            ...
            int blue = resources.getColor(R.color.mb_spring_green);
            int blueDark = resources.getColor(R.color.mb_spring_green);
